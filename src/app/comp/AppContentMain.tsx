...
export default function AppContentMain(props){
  const classes = useStyles();

	const username = () => {
		return <TextField label = "Email/Username" variant="outlined" size="small" className={classes.textField}/>
	}
	const password = () => {
		return <TextField label="Password" variant="outlined" type="password" size="small" className={classes.textField}/>
	}
	...
	const website = () => {
		return <Typography>gmail.com</Typography>
	}
